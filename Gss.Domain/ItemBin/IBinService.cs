...
public interface IBinService
{
    ...
    /// <returns>The bin if it exists; otherwise, <see langword="null"/>.</returns>
    BinModel AddItem(int binId, int itemId);
    ...
    /// <returns>The bin if it exists; otherwise, <see langword="null"/>.</returns>
    BinModel UpdateItemQuantity(int binId, int itemId, int quantity);
    ...
    /// <returns>The bin if it exists; otherwise, <see langword="null"/>.</returns>
    BinModel RemoveItem(int binId, int itemId);
    ...
    (int BinId, BinModel Bin) Create(string description);
